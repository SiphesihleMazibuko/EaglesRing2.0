    ...
    <div className="background-container p-10 text-center">
      ...
      <div className="flex flex-wrap justify-around gap-4 mb-10">
        ...
        <div className="dark:bg-[#917953] p-6 rounded-lg shadow-lg w-64 transform transition duration-300 hover:scale-105">
          ...
          <p className="text-black">
            Get funding from our network of investors who are ready to back
            promising ventures
          </p>
        </div>
        <div className="dark:bg-[#917953] p-6 rounded-lg shadow-lg w-64 transform transition duration-300 hover:scale-105">
          ...
          <p className="text-black">
            Receive mentorship and strategic advice from successful business
            moguls
          </p>
        </div>
        <div className="dark:bg-[#917953] p-6 rounded-lg shadow-lg w-64 transform transition duration-300 hover:scale-105">
        ...
        <div className="dark:bg-[#917953] p-6 rounded-lg shadow-lg w-64 transform transition duration-300 hover:scale-105">
          ...
          <p className="text-black">
            Access a vast library of resources to help you grow your business
          </p>
        </div>
        <div className="dark:bg-[#917953] p-6 rounded-lg shadow-lg w-64 transform transition duration-300 hover:scale-105">
          <h2 className="text-2xl font-semibold mb-2 text-gray-800">
          ...
          <p className="text-black">
            Attend exclusive events and meet industry leaders and potential
            partners
          </p>
        </div>
        <div className="dark:bg-[#917953] p-6 rounded-lg shadow-lg w-64 transform transition duration-300 hover:scale-105">
          ...
          <p className="text-black">
            Create and customize your profile to showcase your business and
            attract investors
          </p>
        </div>
        <div className="dark:bg-[#917953] p-6 rounded-lg shadow-lg w-64 transform transition duration-300 hover:scale-105">
          ...
          <p className="text-black">
            Monitor your progress with our advanced analytics and reporting
            tools
          </p>
        </div>
      </div>
