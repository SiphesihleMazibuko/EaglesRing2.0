...
const Privacy = () => {
  return (
    <div className='background-container p-8'>
      ...
      <div className="max-w-3xl mx-auto">
        ...
        <p className="mb-6">
          We may collect personal information, including but not limited to your name, email address, and other details you provide while using our service.
        </p>
        ...
        <p>
          If you have any questions about this privacy policy or our practices, please contact us at icrdgroup@gmail.com.
        </p>
      </div>
    </div>
  );
